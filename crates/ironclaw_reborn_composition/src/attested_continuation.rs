...
use ironclaw_attestation::{SealedGrantStore, SigningLedger};
use ironclaw_attested_runtime::Broadcaster;

use crate::attested::{ComposedContinuationDriver, RebornAttestedComposition};
...
pub struct RebornAttestedContinuation<B, G, L>
where
...
impl<B, G, L> RebornAttestedContinuation<B, G, L>
where
    B: Broadcaster + 'static,
    G: SealedGrantStore + 'static,
    L: SigningLedger + 'static,
{
    ...
    pub fn new(composition: &RebornAttestedComposition<B, G, L>) -> Self {
        Self {
...
#[async_trait]
impl<B, G, L> AttestedGateContinuationPort for RebornAttestedContinuation<B, G, L>
where
    B: Broadcaster + 'static,
    G: SealedGrantStore + 'static,
    L: SigningLedger + 'static,
